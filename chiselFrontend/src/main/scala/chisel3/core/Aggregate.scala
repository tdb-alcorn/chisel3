...
import scala.collection.immutable.{ListMap, SeqMap, LinkedMap}
...
/** Base class for Aggregates based on key values pairs of String and Data
  ...
  */
abstract class SeqMapRecord(private[chisel3] implicit val compileOptions: CompileOptions) extends Aggregate {
  ...
  /** The collection of [[Data]]
    ...
    * }}}
    */
  val elements: LinkedMap[String, Data]
